        ...
        <CardContent className="pt-5">
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-sm text-gray-700">
              I'm interested in becoming a facilitator for future {siteConfig.name} groups
            </span>
          </label>
      ...
      <Card className="border-[#1B2A4A]/30 print-only hidden print:block">
        <CardContent className="pt-5">
          <p className="text-xs text-gray-400 text-center">
            Generated by {siteConfig.name} — {siteConfig.shortName} Business Creation Course, Week 12
          </p>
        </CardContent>
      </Card>
    </div>
