...
const BlogDetail = () => {
  ...
  return (
    <div className="min-h-screen pt-20 md:pt-28 bg-white">
      <Helmet>
        <title>{localized.displayTitle.length <= 54 ? `${localized.displayTitle} | ${siteConfig.shortName}` : localized.displayTitle}</title>
              ...
              <div className="mt-16 pt-12 border-t border-gray-200 max-w-3xl">
                <div className="bg-gradient-to-r from-[#C9922A]/5 to-[#1B2A4A]/5 rounded-xl p-8 mb-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      {isCentralAsia ? `Изучить программы ${siteConfig.shortName}` : `Explore ${siteConfig.shortName} Programs`}
                    </Link>
                  </div>
                </div>
              </div>
