...
const INTEREST_OPTIONS = [
  { id: "money", labelEn: "Get control of my money", labelRu: "Навести порядок в финансах" },
  { id: "business", labelEn: "Start or grow a business", labelRu: "Открыть или развить бизнес" },
  { id: "leadership", labelEn: "Lead my team or community", labelRu: "Вести за собой команду или сообщество" },
  { id: "cohort", labelEn: "Join a live cohort / local group", labelRu: "Присоединиться к когорте / местной группе" },
  { id: "explore", labelEn: "Just exploring", labelRu: "Просто изучаю" },
];
