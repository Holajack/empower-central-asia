  ...
  keyTopics: [
    {
      ...
      description:
        'The belief that you understand what customers want before you\'ve tested it with them. Nearly every failed business traces back to this moment: an entrepreneur convinced they know the answer before asking the question. Michael Gerber\'s E-Myth calls this the entrepreneurial seizure — the moment a skilled person, confusing technical skill with business knowledge, decides to strike out on their own.',
    },
    {
  ...
  lessonSections: [
    {
      ...
      content: [
        'In his landmark book The E-Myth Revisited, Michael Gerber tells the story of Sarah, a woman who loves baking pies. She\'s brilliant at it. Her friends tell her so constantly. One day, exhausted by her office job and intoxicated by the dream of independence, she decides to open a bakery. Three years in, she\'s exhausted, miserable, and deep in debt. Not because she couldn\'t bake. She could bake magnificently. She failed because she never stopped to ask whether loving to bake and knowing how to run a bakery business are the same thing. They are not. They are almost completely different skill sets. Gerber called this the Fatal Assumption: the dangerous belief that because you understand the technical work of a business, you understand the business that does that technical work.',
