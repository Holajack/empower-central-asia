        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mt-4">
              <strong>Important:</strong> Your consent to receive SMS messages is not required as a condition of any purchase, donation, or service from Businesses Beyond Borders.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mt-4">
              When you text HELP, you will receive the following response:<br />
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              After successfully opting in, you will receive a welcome message:<br />
