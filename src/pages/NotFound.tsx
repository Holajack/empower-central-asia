  ...
  return (
    <>
      <Helmet>
        <title>
          {isCentralAsia
            ? "Страница не найдена | Businesses Beyond Borders"
            : "Page Not Found | Businesses Beyond Borders"}
        </title>
        <meta
          name="description"
          content={
            isCentralAsia
              ? "Запрашиваемая страница не существует. Вернитесь на сайт Businesses Beyond Borders, чтобы узнать о наших программах и возможностях участия."
              : "The page you're looking for doesn't exist. Navigate back to Businesses Beyond Borders to explore volunteer opportunities, our programs, and how you can help empower entrepreneurs in Central Asia."
          }
        />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              {isCentralAsia
                ? "Похоже, эта страница куда-то пропала. Но не беспокойтесь — на сайте Businesses Beyond Borders есть ещё много интересного."
                : "Oops! The page you're looking for seems to have wandered off. But don't worry \u2013 there's still plenty to explore at Businesses Beyond Borders."}
            </p>
