  ...
  return (
    <>
      <Helmet>
        <title>
          {isCentralAsia
            ? "12-недельный курс создания бизнеса | Businesses Beyond Borders"
            : "Free 12-Week Business Creation Course | Businesses Beyond Borders"}
        </title>
        <meta
          name="description"
          content={
        ...
        <link
          rel="canonical"
          href="https://businessesbeyondborders.com/course/business-creation"
        />
        ...
        <meta
          property="og:url"
          content="https://businessesbeyondborders.com/course/business-creation"
        />
        ...
        <meta name="twitter:title" content={isCentralAsia ? "12-недельный курс создания бизнеса" : "Free Business Creation Course | BBB"} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Course",
            name: "12-Week Business Creation Course",
            description:
              "Free, self-paced business creation course covering lean startup methodology, business model canvas, customer discovery, and business plan development.",
            provider: {
            ...
            timeRequired: "PT12W",
            coursePrerequisites: "6-Week Financial Literacy Course",
            hasCourseInstance: {
              "@type": "CourseInstance",
              courseMode: "online",
        ...
        <div className="container mx-auto px-4 pt-24">
          <Breadcrumbs
            items={[
              ...
              { name: "Business Creation", url: "https://businessesbeyondborders.com/course/business-creation" },
            ]}
          />
        </div>
        {/* Hero */}
                        ...
                        >
                          ...
                          <CardContent className="pt-6 pb-5">
                            ...
                            {isGated ? (
                              ...
                              <Link to={`/course/business-creation/${weekNum}`}>
                                <Button
                                  variant="outline"
                                  size="sm"
