...
const BusinessCourseWeek = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="text-center max-w-md">
          ...
          <Link to={`/course/business-creation/${weekNum - 1}`}>
            <Button className="bg-[#C9922A] hover:bg-[#C9922A]/90 text-white">
  ...
  function handleSelectDay(week: number, day: number) {
    if (week !== weekNum) {
      window.location.href = `/course/business-creation/${week}?day=${day}`;
      return;
    }
    navigateDay(day);
  }
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href={`https://businessesbeyondborders.com/course/business-creation/${weekNum}`}
        />
      </Helmet>
