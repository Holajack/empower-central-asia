...
const showcaseFeatures = [
  {
    ...
    color: "teal",
    // Replace with your actual screenshot for Focus Sessions
    image: "/images/feature-focus-sessions.png",
  },
  {
    id: 1,
    icon: Users,
    ...
    color: "forest",
    // Replace with your actual screenshot for Study Rooms
    image: "/images/feature-study-rooms.png",
  },
  {
    id: 2,
    icon: BarChart3,
    ...
    color: "sage",
    // Replace with your actual screenshot for Progress Tracking
    image: "/images/feature-progress-tracking.png",
  },
  {
    id: 3,
    icon: Brain,
    ...
    color: "teal",
    // Replace with your actual screenshot for AI Companion / Nora
    image: "/images/feature-ai-companion.png",
  },
];
...
function MobileShowcase() {
  ...
  return (
    <section className="lg:hidden py-16 bg-gradient-to-b from-white via-cream to-white">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="relative">
            ...
            <div className="iphone-frame relative w-[200px]">
